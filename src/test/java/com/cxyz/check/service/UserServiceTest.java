...
public class UserServiceTest {
    ...
    public void login() {
        System.out.print(userService.login("17478093",
                "123456", UserDto.STUDENT));
        /**测试结果：成功
         * UserDto{id='17478093', name='夏旭晨', sex='男'
